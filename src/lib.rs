...
///
/// ```
pub fn buffer_polygon(input_polygon: &Polygon<f32>, distance: f32) -> MultiPolygon<f32> {
...
/// </details>
///
pub fn buffer_polygon_rounded(input_polygon: &Polygon<f32>, distance: f32) -> MultiPolygon<f32> {
...
pub fn buffer_multi_polygon(
    ...
    let offset_distance = f32::abs(distance);
